...
exports.hardDelete = exports.likePost = exports.updatePost = exports.createPost = void 0;
...
exports.createPost = {
    body: zod_1.default
        ...
        attachments: zod_1.default
            ...
            .max(2)
            .optional(),
        availability: zod_1.default.enum(models_dto_1.AvailabilityEnum).default(models_dto_1.AvailabilityEnum.public),
        allowComments: zod_1.default.enum(models_dto_1.AllowCommentsEnum).default(models_dto_1.AllowCommentsEnum.allow),
